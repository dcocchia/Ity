...
function wrapCustomElement(tagName, options = {}) {
    const Wrapped = react.forwardRef((props, forwardedRef) => {
        const localRef = react.useRef(null);
        const previousPropertyNames = react.useRef(new Set());
        const previousBooleanAttributes = react.useRef(new Set());
...
exports.wrapCustomElement = wrapCustomElement;
